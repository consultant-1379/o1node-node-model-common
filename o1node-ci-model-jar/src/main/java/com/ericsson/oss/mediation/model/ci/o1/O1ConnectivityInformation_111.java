...
@EModel(description = "This MO encapsulates all the connectivity attributes for the O1 based nodes.", name = "O1ConnectivityInformation",
        namespace = "O1_MED", version = "1.1.1")
...
public class O1ConnectivityInformation_111 extends ConnectivityInformation_100 {
    ...
    @Min(value = 1)
    @Max(value = 65535)
    @LifeCycle(value = OBSOLETE, lifeCycleDescription = "No longer used")
